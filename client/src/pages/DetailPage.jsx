              ...
              <div className="lg:w-7/12">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6 text-gray-700 text-sm sm:text-base">
                  ...
                  <div>
                    ...
                    <p className="text-orange-600 font-semibold line-through">Rs. {item.price}</p>
                    <p className="text-green-600 font-semibold flex flex-wrap"> <FaLongArrowAltDown className='h-6' />{item.discount || 0}% OFF</p>
